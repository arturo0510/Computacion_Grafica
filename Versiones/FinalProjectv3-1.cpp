...
int main()
{
	...
	helice_molino = Model();
	helice_molino.LoadModel("Models/helice_molino.obj");
	lamp = Model();
	...
	pointLights[4] = PointLight(0.0f, 1.0f, 1.0f,
		1.5f, 2.0f,
		0.4f, 6.7f, 4.5f,
		0.3f, 0.2f, 0.1f);
	pointLightCount++;
	...
	GLfloat dia_d = 0.0f, dia_a = 0.0f;
	GLfloat noche_d = 2.0f, noche_a = 0.4f;

	//vectores iluminaion
	
	glm::vec3 p0_dr = glm::vec3(-22.5f, 4.7f, 15.4f );
	glm::vec3 p1_dr = glm::vec3(21.8f, 4.7f, 15.4f);
	glm::vec3 p2_dr = glm::vec3(21.8f, 4.7f, 0.4f);
	glm::vec3 p3_dr = glm::vec3(21.8f, 4.7f, -15.4f);
	glm::vec3 color_p = glm::vec3(1.0f, 0.0f, 0.0f);

	//iluminacion estrella 

	//glm::vec3 color_p = glm::vec3(0.0f, 1.0f, 1.0f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		if (dia) {
			pointLights[0].SetInt(10.0f, 10.0f, 10.0f); pointLights[1].SetInt(10.0f, 10.0f, 10.0f);
			pointLights[2].SetInt(10.0f, 10.0f, 10.0f); pointLights[3].SetInt(10.0f, 10.0f, 10.0f);
			pointLights[4].SetInt(10.0f, 10.0f, 10.0f);
			skyboxdia.DrawSkybox(camera.calculateViewMatrix(), projection);
		}
		else {
			pointLights[0].SetInt(0.4f, 0.2f,0.1f); pointLights[1].SetInt(0.4f, 0.2f, 0.1f);
			pointLights[2].SetInt(0.4f, 0.2f, 0.1f); pointLights[3].SetInt(0.4f, 0.2f, 0.1f);
			pointLights[4].SetInt(0.4f, 0.2f, 0.1f);
		...
		//spotLights[1].SetPos(glm::vec3(3.0f, 0.0f, 1.0f));
		...
		model = glm::mat4(1.0);
		if (camera.getIsometric()) model = camera.ConfIsometric(model);
		model = glm::translate(model, glm::vec3(-1.0f, 0.001f, -1.0531f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		arco.RenderModel();
		...
		model = glm::mat4(1.0);
		if (camera.getIsometric()) model = camera.ConfIsometric(model);
		model = glm::translate(model, glm::vec3(43.0f, 0.001f, -1.0531f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		lamp.RenderModel();
		...
		model = glm::mat4(1.0);
		if (camera.getIsometric()) model = camera.ConfIsometric(model);
		model = glm::translate(model, glm::vec3(43.0f, 0.001f, -16.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		lamp.RenderModel();
		...
		model = glm::mat4(1.0);
		if (camera.getIsometric()) model = camera.ConfIsometric(model);
		model = glm::translate(model, glm::vec3(43.0f, 0.001f, -31.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		lamp.RenderModel();
		...
		model = glm::mat4(1.0);
		if (camera.getIsometric()) model = camera.ConfIsometric(model);
		model = glm::translate(model, glm::vec3(14.9f, 8.7f, -8.1531f));
